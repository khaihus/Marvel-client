...
// import culua from '../../img/images.jpg';
        ...
        return (
            <div className="card mt-3 mb-3">
                {(this.props.detail.posterUrl)!==("https://image.tmdb.org/t/p/w500null")
                    ...
                    :<img className="card-img-top" src={'https://media1.tenor.com/images/4691e4eb1ba57dc4ee6e9078976b7f65/tenor.gif?itemid=11252157'} alt="Cú lừa ok?"/>
