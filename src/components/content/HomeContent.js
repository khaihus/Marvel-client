            ...
            <div className="card-deck mt-mb-5">
                ...
                <Link to = {`/movies/299536`} className="elementlink">
                    <div className="card mt-mb-3">
                        <img className="card-img-top" src={require("../../img/a2.jpg")} alt="Cú lừa"/>
                ...
                <div className="card mt-mb-3">
                    <Link to = {`/movies/335983`} className="elementlink">
                        <img className="card-img-top" src={require("../../img/venom1.jpg")} alt="Cú lừa"/>
                        <div className="card-body">
                ...
                <div className="card mt-mb-3">
                    <Link to = {`/movies/299537`} className="elementlink">
                        <img className="card-img-top" src={require("../../img/capmavel.jpg")} alt="Cú lừa"/>
                        <div className="card-body">
                ...
                <span className="float-sm-right mt-3"><Link to={`/movies`} className="showMore">Show More>></Link></span>
                <br/>
